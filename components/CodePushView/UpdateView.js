...
import { View, ImageBackground, Text, ActivityIndicator, TouchableOpacity, ScrollView, Dimensions, TouchableWithoutFeedback } from "react-native";
export default class UpdateView extends PureComponent {
    render() {
        ...
        }} resizeMode="contain" source={require("../../icons/app_update_bg.png")}/>
        <View style={{
            backgroundColor: "#fff",
            minHeight: 180,
        ...
        <View style={{ backgroundColor: "#fff", paddingVertical: 15 }}>
          <TouchableOpacity activeOpacity={0.8} onPress={() => {
            ...
            : (progress * 100).toFixed(1) + "%"}
              ...
              </View>) : (<Text style={{ fontSize: 16, color: "#fff" }}>立即更新</Text>)}
          </TouchableOpacity>
        </View>
